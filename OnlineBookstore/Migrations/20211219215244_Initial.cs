        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameStatus = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstanceBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstanceBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstanceBooks_Publishers_PublisherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_ShoppingBaskets_Id",
                        column: x => x.Id,
                        principalTable: "ShoppingBaskets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstanceBooks_BookId",
                table: "InstanceBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_InstanceBooks_PublisherId",
                table: "InstanceBooks",
                column: "PublisherId");

            migrationBuilder.CreateIndex(
                name: "IX_InstanceBooks_ShoppingBasketId",
                table: "InstanceBooks",
                column: "ShoppingBasketId");

            migrationBuilder.CreateIndex(
                name: "IX_InstanceBooks_WarehouseId",
                table: "InstanceBooks",
                column: "WarehouseId");
